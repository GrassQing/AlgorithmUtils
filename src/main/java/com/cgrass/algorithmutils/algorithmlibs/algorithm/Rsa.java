...
/** */
     ...
     * @throws Exception
     */
    public static byte[] decryptByPrivateKeySort(byte[] encryptedData, String privateKey)
            throws Exception {
...
/** */
    ...
    public static byte[] decryptByPublicKeySort(byte[] encryptedData1, String publicKey)
            throws Exception {
        byte[] encryptedData = android.util.Base64.decode(encryptedData1, android.util.Base64.DEFAULT);
        byte[] keyBytes = publicKey.trim().getBytes();
        X509EncodedKeySpec x509KeySpec = new X509EncodedKeySpec(android.util.Base64.decode(keyBytes, android.util.Base64.DEFAULT));
        KeyFactory keyFactory = KeyFactory.getInstance(KEY_ALGORITHM);
...
//                cache = cipher.doFinal(encryptedData, offSet, inputLen - offSet);
     ...
     * @throws Exception
     */
    public static byte[] encryptByPublicKeySort(byte[] data, String publicKey)
            throws Exception {
